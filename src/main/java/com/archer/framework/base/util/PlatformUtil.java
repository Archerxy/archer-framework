    ...
    static String getNativeLibraryResourcePrefix(int osType, String arch, String name) {
        ...
        switch(osType) {
            ...
            case PlatformUtil.WINDOWS:
                osPrefix = "win32-" + arch;
                break;
            case PlatformUtil.WINDOWSCE:
                osPrefix = "w32ce-" + arch;
                break;
            case PlatformUtil.MAC:
                osPrefix = "darwin-" + arch;
                break;
            case PlatformUtil.LINUX:
                osPrefix = "linux-" + arch;
                break;
            case PlatformUtil.SOLARIS:
                osPrefix = "sunos-" + arch;
                break;
            case PlatformUtil.FREEBSD:
                osPrefix = "freebsd-" + arch;
                break;
            case PlatformUtil.OPENBSD:
                osPrefix = "openbsd-" + arch;
                break;
            case PlatformUtil.NETBSD:
                osPrefix = "netbsd-" + arch;
                break;
            case PlatformUtil.KFREEBSD:
